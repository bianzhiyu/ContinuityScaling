...
set(ylabel('$\langle\delta^t_{x_1}\rangle_t$'),...
    'Interpreter','latex');
savefig(FH,'E2log_1c2.fig');
print(FH,'E2log_1c2.png','-dpng');
print(FH,'E2log_1c2.eps','-depsc');
...
set(ylabel('$\langle\delta^t_{x_2}\rangle_t$'),...
    'Interpreter','latex');
savefig(FH,'E2log_2c1.fig');
print(FH,'E2log_2c1.png','-dpng');
print(FH,'E2log_2c1.eps','-depsc');
